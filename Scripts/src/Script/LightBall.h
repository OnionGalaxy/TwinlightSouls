...
private:
	...
	bool GetCloserEnemy(float3& closer_position);
	void AutoAimLightball();
	void SetLightballColor() const;
...
private:
	...
	//AutoAim
	float smooth_autoaim_rotation = 0.025f;
	float angle_autoaim = 0.8f;
	friend AllyInteractionsScript;

	//Agressive lightball color
	float4 interior_initial_color = float4::zero;
	float4 interior_initial_color_emissive = float4::zero;

	float4 exterior_initial_color = float4::zero;
	float4 exterior_initial_color_emissive = float4::zero;

	float4 small_initial_color = float4::zero;
	float4 small_initial_color_emissive = float4::zero;

	float4 trail_initial_color = float4::zero;
	float4 trail_initial_color_to_blend = float4::zero;
