...
public:
	...
	void Move(int player, bool can_move = false);
...
private:
	...
	const float default_speed_horizontal = 8.5f;
	...
	float3 direction;
	float3 velocity;
	const float default_acceleration = 0.06f;
	const float default_deceleration = 0.06f;
