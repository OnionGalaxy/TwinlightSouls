#ifndef  __NEWMUSHDOOMBALL_H__
#define  __NEWMUSHDOOMBALL_H__
...
class NewMushdoomBall : public Script
{
public:
	NewMushdoomBall();
	~NewMushdoomBall() = default;
...
extern "C" SCRIPT_API NewMushdoomBall* NewMushdoomBallDLL(); //This is how we are going to load the script
#endif