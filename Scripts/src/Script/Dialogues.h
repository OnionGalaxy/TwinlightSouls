...
struct AllyLightBallTransform : Dialogue
{
	void Init() override
	{
		...
		sentences.push_back(Sentence{ "There may still be hope for Niberry..." ,DialogueFeeling::HAPPY });
...
struct AllyLightShieldTutorial : Dialogue
{
	void Init() override
	{
		...
		sentences.push_back(Sentence{ "You can create a shield using your      purifying light.",DialogueFeeling::IDLE });
...
struct AllyBossKilled : Dialogue
{
	void Init() override
	{
		id = DialogueID::BOSS_KILLED;
		sentences.push_back(Sentence{ "We have won! the corruptions is dissapearing",DialogueFeeling::IDLE });
		sentences.push_back(Sentence{ "You just need to bring me back to the heart",DialogueFeeling::IDLE });
		sentences.push_back(Sentence{ "where I belong",DialogueFeeling::IDLE });
	}
};
#endif
