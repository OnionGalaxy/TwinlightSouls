...
public:
	...
	void SetAvalancheSpeed(float min_time, float max_time);
...
private:
	...
	void SetBossShadowCaster(bool caster) const;
...
public:
	...
	float player_range_factor = 1.5f;
...
private:
	...
	//Dissolver effect
	Dissolver* boss_dissolver = nullptr;
	...
	//Avalanche
	float max_remaining_rock_time_alive = 1000.f;
	float min_remaining_rock_time_alive = 200.f;
	...
	//Spawn orbs
	mutable float3 current_damage_position = float3::zero;
};
