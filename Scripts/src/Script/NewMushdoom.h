#ifndef  __NEWMUSHDOOM_H__
#define  __NEWMUSHDOOM_H__
...
class NewMushdoom : public EnemyController
{
public:
	NewMushdoom();
	~NewMushdoom() = default;
...
private:
	...
	bool IsColliding(NewRayHit* collision, const LineSegment& ray, bool only_mesh = false);
...
public:
	typedef EnemyState<NewMushdoom> NewMushdoomState;
	NewMushdoomState* current_state = nullptr;
	NewMushdoomState* previous_state = nullptr;
	NewMushdoomState* idle_state = nullptr;
	NewMushdoomState* scream_state = nullptr;
	NewMushdoomState* pursue_state = nullptr;
	NewMushdoomState* attack_state = nullptr;
	NewMushdoomState* die_state = nullptr;
	NewMushdoomState* hit_state = nullptr;
	NewMushdoomState* throw_state = nullptr;

	NewMushdoomBall* mushdoom_ball = nullptr;
...
private:
	...
	NewRayHit* horizontal_ray_detector_middle = nullptr;
	float horizontal_ray_middle_position = 0.5f;
	float horizontal_ray_middle_length = 1.5f;

	NewRayHit* horizontal_ray_detector_knee = nullptr;
	...
	NewRayHit* main_vertical_ray_detector = nullptr;
	float vertical_ray_main_position = 0.3f;
	bool main_vertical_ray = false;

	NewRayHit* border_vertical_ray_detector = nullptr;
	...
	//Diagonal
	NewRayHit* main_diagonal_ray_detector = nullptr;
...
extern "C" SCRIPT_API NewMushdoom* NewMushdoomDLL(); // This is how we are going to load the script
#endif