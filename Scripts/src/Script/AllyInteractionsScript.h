...
public:
	...
	void SetLightballPositionReference();
	...
	//tutorial first pop up
	void TutorialSkippablePopUp();
	InputManager* GetCurrentInput() const;
	TutorialHelper* GetTutorialHelper() const;
	bool tutorial_request = true;
	bool do_tutorial = true;

	//teleport ally due to the tutorial skippable
	bool GetIsTeleported() const;
	void SetIsTeleported(bool is_ally_teleported);
