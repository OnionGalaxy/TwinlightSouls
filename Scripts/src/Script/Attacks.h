...
struct Node
{
	...
	bool is_smash = false;
	float smash_anim_percentatge = 0.2f;
...
struct NoCombo : Node
{
	void Init() override
	{
		...
		transitions.insert(std::pair<Move, NodeID>(Move::LIGHT_JUMP_ATTACK, NodeID::LIGHT_JUMP_ATTACK));
		damage = 0;
		animation = "idle";
...
struct LightJumpAttack : Node
{
	void Init() override
	{
		id = NodeID::LIGHT_JUMP_ATTACK;
		damage = 40;
		min_transition_animation_time = 0.75f;
		percentatge_of_collision = 0.60f;
		percentatge_of_sfx = 0.30f;
		animation = "light_jump_attack";
		animation_state = "LightJumpAttack";
		distance = 0;
		speed = -1.f;
		is_aerial = true;
		attack_range_distance = 3.f;
		attack_range_angle = 0.4f;
		smash_anim_percentatge = 0.30f;
		//Sound
		sfx_attack = "play_backflip_player";
...
struct LightThreeFemale : Node
{
	void Init() override
	{
		...
		//VFX
		vfx_attack_indexes.push_back(10);
		vfx_attack_indexes.push_back(11);
		count_of_emit_vfx.push_back(32);
	}
};

struct HeavyOneFemale : Node
{
	void Init() override
	{
		id = NodeID::HEAVY_ONE;
		...
		vfx_attack_indexes.push_back(10);
		vfx_attack_indexes.push_back(11);
		vfx_attack_indexes.push_back(12);
		count_of_emit_vfx.push_back(22);
	}
};


struct HeavyTwoFemale : Node
{
	void Init() override
	{
		id = NodeID::HEAVY_TWO;
...
struct DownSmashFemale : Node
{
	void Init() override
	{
		id = NodeID::DOWN_SMASH;
		damage = 40;
		min_transition_animation_time = 0.1f;
		percentatge_of_collision = 0.60f;
		percentatge_of_sfx = 0.30f;
		animation = "down_tail_smash";
		animation_state = "DownTailSmash";
