...
void LightShield::Update()
{
	...
	ui_manager->ShowShieldBar(active || broken, static_cast<uint32_t>(player_controller->player));
}
...
void LightShield::CastShield()
{
	...
	ui_manager->ShowShieldBar(true, static_cast<uint32_t>(player_controller->player));
